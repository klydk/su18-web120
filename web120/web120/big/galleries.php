...
<html>
<head>
<title>Galleries and Sliders</title>
...
<div class="wrapper">
<header>
  <h1><a href="index.php"><i class="logo fa fa-pencil-square-o"></i>Kelsey's Web Development Research and Examples</a></h1>
  <nav id="cssmenu">
  <ul>
...
<!-- START LEFT COL -->
<section>
 <h2 class="pageID">Galleries and Sliders</h2>
        ...
        <p>Copy and paste my Image Galleries research and citations to this page when ready.</p>
